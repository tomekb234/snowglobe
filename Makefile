...
build/main.o: src/main.cpp include/input.hpp include/diagnostic.hpp gen/parser.hpp | build
	$(CXXC) $< -o $@

build/input.o: src/input.cpp include/input.hpp | build
	$(CXXC) $< -o $@

build/lexer.o: gen/lexer.cpp include/input.hpp include/diagnostic.hpp gen/parser.hpp | build
	$(CXXC) $< -o $@
