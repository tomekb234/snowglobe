...
namespace sg {
    ...
    class code_generator {
        ...
        void define_enum_type_with_variants(
        ...
        typed_llvm_value<> make_enum_variant_value(
                prog::global_index enum_index,
                prog::variant_index variant_index,
        ...
        typed_llvm_value<> make_pointer_value(
                ll_type* type,
                llvm::Value* data_ptr,
        ...
        typed_llvm_value<> make_external_scanf_call(string format, vector<llvm::Value*> args, llvm::IRBuilderBase& builder);

        // builtin functions
        void define_builtin_read_int_func(llvm::Function* func);
        void define_builtin_read_uint_func(llvm::Function* func);
        void define_builtin_read_float_func(llvm::Function* func);
        ...
        void define_builtin_error_func(llvm::Function* func);
        void define_builtin_unreachable_func(llvm::Function* func);
    };
    ...
    class function_code_generator {
        ...
        function_code_generator(
                code_generator& gen,
                const prog::global_func& func,
                code_generator::typed_llvm_value<llvm::Function> llvm_function)
                : gen(gen), func(func), llvm_function(llvm_function.value), return_type(llvm_function.type) {}

        void generate();

        private:

        llvm::BasicBlock* process_instr_block(
